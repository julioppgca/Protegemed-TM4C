...
linker.cmd: package/cfg/RTOS_16eth_clean_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/RTOS_16eth_clean_pem4fcfg.cmd\)\"$""\"C:/Protegemed/ADC_DMA16ch_ETH_Clean/.config/xconfig_RTOS_16eth_clean/\1\""' package/cfg/RTOS_16eth_clean_pem4f.xdl > $@
