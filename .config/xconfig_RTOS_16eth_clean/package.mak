...
override PKGDIR = xconfig_RTOS_16eth_clean
...
package/%.xdc.inc package/%_xconfig_RTOS_16eth_clean.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_RTOS_16eth_clean" (because $@ is older than $(firstword $?))" ...
...
.PHONY: release,xconfig_RTOS_16eth_clean
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_RTOS_16eth_clean.tar.dep
endif
package/rel/xconfig_RTOS_16eth_clean/xconfig_RTOS_16eth_clean/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_RTOS_16eth_clean/xconfig_RTOS_16eth_clean/package/package.rel.xml: package/build.cfg
package/rel/xconfig_RTOS_16eth_clean/xconfig_RTOS_16eth_clean/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_RTOS_16eth_clean/xconfig_RTOS_16eth_clean/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_RTOS_16eth_clean.tar: package/rel/xconfig_RTOS_16eth_clean.xdc.inc package/rel/xconfig_RTOS_16eth_clean/xconfig_RTOS_16eth_clean/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_RTOS_16eth_clean.xdc.inc,package/rel/xconfig_RTOS_16eth_clean.tar.dep)


release release,xconfig_RTOS_16eth_clean: all xconfig_RTOS_16eth_clean.tar
clean:: .clean
	-$(RM) xconfig_RTOS_16eth_clean.tar
	-$(RM) package/rel/xconfig_RTOS_16eth_clean.xdc.inc
	-$(RM) package/rel/xconfig_RTOS_16eth_clean.tar.dep
