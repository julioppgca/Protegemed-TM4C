...
override PKGDIR = xconfig_RTOS_16config
...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-arm_15.12.1.LTS
...
package/%.xdc.inc package/%_xconfig_RTOS_16config.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_RTOS_16config" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: RTOS_16config.pem4f

-include package/cfg/RTOS_16config_pem4f.mak
-include package/cfg/RTOS_16config_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/RTOS_16config_pem4f.dep
endif
RTOS_16config.pem4f: package/cfg/RTOS_16config_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
RTOS_16config.pem4f package/cfg/RTOS_16config_pem4f.c: .libraries,em4f
endif

package/cfg/RTOS_16config_pem4f.c package/cfg/RTOS_16config_pem4f.h package/cfg/RTOS_16config_pem4f.xdl: override _PROG_NAME := RTOS_16config.xem4f
package/cfg/RTOS_16config_pem4f.c: package/cfg/RTOS_16config_pem4f.cfg
package/cfg/RTOS_16config_pem4f.xdc.inc: package/cfg/RTOS_16config_pem4f.xdl
package/cfg/RTOS_16config_pem4f.xdl package/cfg/RTOS_16config_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/RTOS_16config_pem4f.cfg
	-$(RM) package/cfg/RTOS_16config_pem4f.dep
	-$(RM) package/cfg/RTOS_16config_pem4f.c
	-$(RM) package/cfg/RTOS_16config_pem4f.xdc.inc

clean,em4f::
	-$(RM) RTOS_16config.pem4f
.executables,em4f .executables: RTOS_16config.xem4f

RTOS_16config.xem4f: |RTOS_16config.pem4f

-include package/cfg/RTOS_16config.xem4f.mak
RTOS_16config.xem4f: package/cfg/RTOS_16config_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/RTOS_16config_pem4f.oem4f   package/cfg/RTOS_16config_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
RTOS_16config.xem4f: export C_DIR=
RTOS_16config.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
RTOS_16config.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

RTOS_16config.test test,em4f test: RTOS_16config.xem4f.test

RTOS_16config.xem4f.test:: RTOS_16config.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 RTOS_16config.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.RTOS_16config.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,RTOS_16config.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) RTOS_16config.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
RTOS_16config_pem4f.oem4f,copy : package/cfg/RTOS_16config_pem4f.oem4f
RTOS_16config_pem4f.sem4f,copy : package/cfg/RTOS_16config_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_RTOS_16config
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_RTOS_16config.tar.dep
endif
package/rel/xconfig_RTOS_16config/xconfig_RTOS_16config/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_RTOS_16config/xconfig_RTOS_16config/package/package.rel.xml: package/build.cfg
package/rel/xconfig_RTOS_16config/xconfig_RTOS_16config/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_RTOS_16config/xconfig_RTOS_16config/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_RTOS_16config.tar: package/rel/xconfig_RTOS_16config.xdc.inc package/rel/xconfig_RTOS_16config/xconfig_RTOS_16config/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_RTOS_16config.xdc.inc,package/rel/xconfig_RTOS_16config.tar.dep)


release release,xconfig_RTOS_16config: all xconfig_RTOS_16config.tar
clean:: .clean
	-$(RM) xconfig_RTOS_16config.tar
	-$(RM) package/rel/xconfig_RTOS_16config.xdc.inc
	-$(RM) package/rel/xconfig_RTOS_16config.tar.dep
